...
/**
 * Implementation of InsurancePlanDao interface.
 * Provides methods to perform database operations on InsurancePlan entities.
 */
public class InsurancePlanDaoImpl implements InsurancePlanDao {
    ...
    private static final CreateInsuranceMessageConstants msg = CreateInsuranceMessageConstants.getInstance();
