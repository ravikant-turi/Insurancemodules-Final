	...
	<div class="wrapper">
		<h:form>
			<div class="button-container">
				<h:commandButton value="create" action="InsuranceAdminDashBoard.jsp"
					styleClass="action-btn create-btn" />
			</div>
		</h:form>
		<div class="header">
			<img
		...
		<div class="container">
			<h:form>
				<div class="plans-grid">
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('SELF')}"
						styleClass="plan-box">
						<div>
							<img
					...
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('FAMILY')}"
						styleClass="plan-box">
						<div>
							<img
					...
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('SENIOR')}"
						styleClass="plan-box">
						<div>
							<img
					...
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('CRITICAL_ILLNESS')}"
						styleClass="plan-box">
						<div>
							<img
					...
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('SUPER_ELITE')}"
						styleClass="plan-box">
						<div>
							<img
					...
					<h:commandLink
						action="#{insurancePlanController.showPlanCoverageByPlanDetailsByPlanType('EPIDEMIC_PROTECT')}"
						styleClass="plan-box">
						<div>
							<img
