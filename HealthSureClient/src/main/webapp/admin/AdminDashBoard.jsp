	...
	<f:view>
		...
		<div class="max-w-5xl mx-auto px-4 pt-6 pb-2">
			<h2 class="text-2xl font-bold text-blue-800">
				Welcome,
				<h:outputText value="#{insuranceDashboardController.companyName}" />
				Ravikant Turi 📊
			</h2>
			<p class="text-gray-600 mt-1">Your comprehensive overview of
				operations is below.</p>
		</div>
			...
			<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
				...
				<h:form>
					<h:commandLink action="Show"
						styleClass="block bg-white p-5 rounded-xl shadow-md text-center hover:shadow-xl transition">
						<h3
							class="text-md font-semibold text-blue-500 uppercase tracking-wide">Total
							Policies</h3>
				...
				<%-- New Policies Issued --%>
				<h:form>
					<h:commandLink action="/insurance/showInsuranceCoverageOption.jsp"
						styleClass="block bg-white p-5 rounded-xl shadow-md text-center hover:shadow-xl transition">
						<h3
							class="text-md font-semibold text-purple-600 uppercase tracking-wide">Show
							Insurance</h3>
						<p class="mt-2 text-4xl font-bold text-gray-800">
							<h:outputText
								value="#{insuranceDashboardBean.newPoliciesIssuedToday}" />
						</p>
				...
				<%-- Claims Processed --%>
				<h:form>
					<h:commandLink action="/insurance/companymenu.jsp"
						styleClass="block bg-white p-5 rounded-xl shadow-md text-center hover:shadow-xl transition">
						<h3
							class="text-md font-semibold text-green-600 uppercase tracking-wide">Show
							Coverage</h3>
						<p class="mt-2 text-4xl font-bold text-gray-800">
							<h:outputText
								value="#{insuranceDashboardBean.claimsProcessedThisMonth}" />
						</p>
				...
				<%-- Pending Claims --%>
				<h:form>
					<h:commandLink action="#{insuranceDashboardBean.viewPendingClaims}"
						styleClass="block bg-white p-5 rounded-xl shadow-md text-center hover:shadow-xl transition">
						<h3
							class="text-md font-semibold text-red-500 uppercase tracking-wide">Pending
							Claims</h3>
						<p class="mt-2 text-4xl font-bold text-gray-800">
		...
		<div class="max-w-4xl mx-auto mb-10 px-4">
			<div
				...
				<p class="text-sm text-blue-900 italic">"Insurance is a
					financial safety net that catches you when you fall."</p>
			</div>
		</div>

		<div class="max-w-4xl mx-auto px-4 text-center mb-20">
			<h3 class="text-xl font-semibold text-gray-700 mb-4">Quick
				Actions</h3>
			<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
				<h:form>
					<h:commandButton value="➕ New Policy Application"
						action="#{insuranceDashboardBean.createNewPolicy}"
				...
				<h:form>
					<h:commandButton value="🔍 Search Policies"
						action="#{insuranceDashboardBean.searchPolicies}"
				...
				<h:form>
					<h:commandButton value="💲 Manage Claims"
						action="#{insuranceDashboardBean.manageClaims}"
				...
				<h:form>
					<h:commandButton value="📞 Customer Support Tickets"
						action="#{insuranceDashboardBean.viewSupportTickets}"
